...
import IconWebsite from "../../../atoms/icons/website";
  ...
  return (
    ...
    >
      ...
      <Content open={animation}>
        ...
        {selected &&
          (selected.linkedIn || selected.facebook || selected.website) && (
            <Space top="160">
              <Social>
                {selected.linkedIn && (
                  <a
                    ...
                    target="_blank"
                    aria-label={`${selected.title} - linkedIn`}
                ...
                {selected.facebook && (
                  <a
                    ...
                    target="_blank"
                    aria-label={`${selected.title} - facebook`}
                    rel="noopener noreferrer"
                  >
                    <IconFacebook />
                  </a>
                ...
                {selected.website && (
                  <a
                    ...
                    target="_blank"
                    aria-label={`${selected.title} - website`}
                    rel="noopener noreferrer"
                  >
                    <IconWebsite />
                  </a>
